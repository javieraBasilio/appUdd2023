...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Widget> _pages = [
    //aqui estoy generando las clases para que me empujen a las otras paginas
    const DetalleRestoran(),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            //DIVISIÓN PARA EL SIGUIENTE ROW CON CARDS
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const DetalleRestoran()),
                        );
                      },
                      child: ListView.builder(
                        scrollDirection:
