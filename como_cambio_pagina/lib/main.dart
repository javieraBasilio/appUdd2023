...
import 'package:como_cambio_pagina/items.dart';
import 'package:como_cambio_pagina/theme.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            _buildTab('Grupos', 0),
            _buildTabWithNumberAndColor(
                'Chats', 5, _isChatsTabActive), // Agregar el círculo
                  ...
                  children: <Widget>[
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Grupo 1'),
                        ));
                      },
                      child: groupItem(),
                    ),
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Grupo 2'),
                        ));
                      },
                      child: groupItem(),
                    ),
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Grupo 3'),
                        ));
                      },
                      child: groupItem(),
                    ),
                  ...
                  children: <Widget>[
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Beethoven'),
                        ));
                      },
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Chopin'),
                        ));
                      },
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Liszt'),
                        ));
                      },
                      child: lisztListItem(),
                    ),
                  ...
                  children: <Widget>[
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Novedades 1'),
                        ));
                      },
                      child: novedadesItem(),
                    ),
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Novedades 2'),
                        ));
                      },
                      child: novedadesItem(),
                    ),
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Novedades 3'),
                        ));
                      },
                      child: novedadesItem(),
                    ),
                  ...
                  children: <Widget>[
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Mamá 1'),
                        ));
                      },
                      child: llamadasItem(),
                    ),
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Mamá 2'),
                        ));
                      },
                      child: llamadasItem(),
                    ),
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              createDetailScreen(context, 'Mamá 3'),
                        ));
                      },
                      child: llamadasItem(),
                    ),
          ...
          ? FloatingActionButton(
              ...
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(
                    8.0), // Hace que las esquinas sean redondeadas con un radio de 8
              ),
              child: const Icon(
                Icons.message,
                color: Colors.white,
