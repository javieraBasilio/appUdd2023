              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: const Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.fromLTRB(12, 0, 0,
                      ...
                      SizedBox(
                          width:
                              16), // Espacio entre el ícono de búsqueda y el TextField
                      Expanded(
                        child: TextField(
                      ...
                      Padding(
                        padding: EdgeInsets.fromLTRB(0, 0, 12,
                            0), // Margen derecho para el ícono de filtro
...
*/
              ...
              Row(
                children: [
                  ...
                  const SizedBox(
                      width:
                          6.0), //OMITIBLE PARA QUE FUNCIONE SIMÉTRICAMENTE EL PADDING
                  /*3ER EXPANDED*/
                  Expanded(
                    flex: 1,
                    child: Padding(
              ...
              const Padding(
                ...
                child:
                    Card1(), // Simplemente utiliza SimpleCard en lugar de anidar otro Container
              ),
              const Padding(
                padding: EdgeInsets.fromLTRB(16, 8, 16, 0),
                child:
                    Card2(), // Simplemente utiliza SimpleCard en lugar de anidar otro Container
              ),
            ],
          ),
        ), // Se cierra el body
          ...
          items: const [
            BottomNavigationBarItem(
              icon: Icon(Icons.home_outlined,
                  color: Colors.black), // Icono blanco
              label: 'Home',
            ),
            BottomNavigationBarItem(
